...
export default function SignInForm() {
  ...
  return (
    <div className="flex flex-col flex-1 px-4 sm:px-6 lg:px-0">
      <div className="w-full max-w-md pt-6 sm:pt-10 mx-auto">
        <Link
          to="/dashboard"
          ...
          <div>
            ...
            <div className="mt-6 p-4 bg-gray-50 rounded-lg dark:bg-gray-800">
              ...
              <div className="text-xs text-gray-500 dark:text-gray-500 space-y-1">
                <p><strong>Admin:</strong> admin@dms.com / admin123</p>
                <p><strong>User:</strong> user@dms.com / user123</p>
              </div>
            </div>
          </div>
        </div>
